...
`JA4_s1` / `JA4_rs1` are huginn-only (`stable-v1`); they are not in the FoxIO JA4 spec. [JA4S1.md](https://github.com/biandratti/huginn-net/blob/master/huginn-net-tls/JA4S1.md).
