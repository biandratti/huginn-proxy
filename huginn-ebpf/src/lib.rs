...
pub use config::{CaptureBackend, SynRateLimit, XdpAttachMode};
...
pub use probe::{
    ...
    syn_rate_skipped_v4_count_from_path, syn_rate_skipped_v6_count_from_path, EbpfLogPoller,
    EbpfProbe, DEFAULT_SYN_MAP_MAX_ENTRIES,
};
